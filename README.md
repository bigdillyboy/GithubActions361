[![Run App DylanMostek](https://github.com/bigdillyboy/GithubActions361/actions/workflows/run-app.yaml/badge.svg)](https://github.com/bigdillyboy/GithubActions361/actions/workflows/run-app.yaml)
